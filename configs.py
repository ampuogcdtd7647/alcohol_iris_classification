...
class Config:
    def __init__(self):
        # 数据路径相关
        self.train_image_dir = r'/data/hurong/iris_alcohol/data/train_image/train_image'
        self.train_numeric_data_dir = r'/data/hurong/iris_alcohol/data/train_csv/train_csv'
        self.output_dir = r'/data/hurong/iris_alcohol/result'
        ...
        self.target_fpr = 0.001
        self.train_val_test_split = (0.8, 0.2)
        self.random_seed = 77

        #测试相关
        self.test_numeric_data_dir=r'/data/hurong/iris_alcohol/data/test_csv'
        self.test_image_dir=r'/data/hurong/iris_alcohol/data/test_image/test_image'
